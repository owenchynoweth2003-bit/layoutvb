export const WALLPRESETS = [
  ...
  { id: 'shower3_floor', name: '3-Wall + Floor', desc: 'Shower w/ floor', p: [{ name: 'Left Wall', w: 36, h: 96 }, { name: 'Back Wall', w: 60, h: 96 }, { name: 'Right Wall', w: 36, h: 96 }, { name: 'Floor', w: 60, h: 36 }] },
  { id: 'shower3_ceil', name: '3-Wall + Ceiling', desc: 'Steam shower', p: [{ name: 'Left Wall', w: 36, h: 96 }, { name: 'Back Wall', w: 60, h: 96 }, { name: 'Right Wall', w: 36, h: 96 }, { name: 'Ceiling', w: 60, h: 36 }] },
  { id: 'full_enclosure', name: 'Full Enclosure', desc: 'Walls + Floor + Ceiling', p: [{ name: 'Left', w: 36, h: 96 }, { name: 'Back', w: 60, h: 96 }, { name: 'Right', w: 36, h: 96 }, { name: 'Floor', w: 60, h: 36 }, { name: 'Ceiling', w: 60, h: 36 }] },
